...
//    szTip: array[0..63] of AnsiChar;
  ...
  private
    ...
    ClickTimer: TTimer;                // For distinguishing click and dbl.click
    IsDblClick: Boolean;
        ...
        be unable to shut down. }
{
      ...
      WM_QUERYENDSESSION, WM_CLOSE, WM_QUIT, WM_DESTROY, WM_NCDESTROY, WM_USERCHANGED:
        Msg.Result := 1;
...
procedure TCoolTrayIcon.TimerClick(Sender: TObject);
begin
  ClickTimer.Enabled := False;
